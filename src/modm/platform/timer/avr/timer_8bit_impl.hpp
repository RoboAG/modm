...
Timer8Bit::clockSourcePeriod(ClockSource clock)
{
	switch (clock)
	{
...
constexpr Timer8Bit::ClockSource
Timer8Bit::getPrescaler(ClockCycles<SystemClock::Timer> minTickPeriod)
{
...
constexpr Timer8Bit::ClockSource
Timer8Bit::selectPrescalerForMaxResolution(ClockCycles<SystemClock::Timer> period)
{
...
template<bool dualSlope>
constexpr Timer8Bit::CountType
Timer8Bit::computeTopValue(ClockSource prescaler, ClockCycles<SystemClock::Timer> period)
{
...
template<bool dualSlope>
constexpr ClockCycles<SystemClock::Timer>
Timer8Bit::computePeriod(ClockSource prescaler, CountType topValue)
{
	ClockCycles<SystemClock::Timer> tickPeriod = clockSourcePeriod(prescaler);
